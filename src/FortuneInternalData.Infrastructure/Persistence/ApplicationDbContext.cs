...
public class ApplicationDbContext : IdentityDbContext<IdentityApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PhoneNumberRecord>(entity =>
        {
            ...
            entity.Property(x => x.Web11).HasColumnName("web11").HasMaxLength(3);
            entity.Property(x => x.Web12).HasColumnName("web12").HasMaxLength(3);
            entity.Property(x => x.Web13).HasColumnName("web13").HasMaxLength(3);
            entity.Property(x => x.Web14).HasColumnName("web14").HasMaxLength(3);
            entity.Property(x => x.Web15).HasColumnName("web15").HasMaxLength(3);
            entity.Property(x => x.Web16).HasColumnName("web16").HasMaxLength(3);
            entity.Property(x => x.Web17).HasColumnName("web17").HasMaxLength(3);
            entity.Property(x => x.Web18).HasColumnName("web18").HasMaxLength(3);
            entity.Property(x => x.Web19).HasColumnName("web19").HasMaxLength(3);
            entity.Property(x => x.Web20).HasColumnName("web20").HasMaxLength(3);
